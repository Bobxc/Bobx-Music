...
__DEFINE__(1686017823001, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1686017823002,"./event-store":1686017823003}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1686017823002, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1686017823003, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1686017823002,"./utils":1686017823004}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1686017823004, function(require, module, exports) {
...
return __REQUIRE__(1686017823001);
})()
